...
urlpatterns = [
    ...
    url(r'^Predict_Drug_Side_Effect_Type/$', remoteuser.Predict_Drug_Side_Effect_Type, name="Predict_Drug_Side_Effect_Type"),
    ...
    url(r'^View_Predicted_Drug_Side_Effect_Type_Ratio/$', serviceprovider.View_Predicted_Drug_Side_Effect_Type_Ratio, name="View_Predicted_Drug_Side_Effect_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Predicted_Drug_Side_Effect_Type/$', serviceprovider.View_Predicted_Drug_Side_Effect_Type, name="View_Predicted_Drug_Side_Effect_Type"),
