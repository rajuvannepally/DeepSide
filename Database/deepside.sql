...
--
-- Host: localhost
-- Generation Time: Oct 04, 2023 at 08:21 AM
...
-- Database: `deepside`
--
CREATE DATABASE IF NOT EXISTS `deepside` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `deepside`;
...
('5pnj5v04567xcwqfr1yu2cv5gaba4b7k', 'eyJ1c2VyaWQiOjF9:1qnvkD:-v_KvvxlMORl6tprIGCAiv5N4D7Ldj2QUSRe9TYJurA', '2023-10-18 06:52:29.747079'),
...
('g61kmmckemrrhkh6kbfbvk3a9mjr11vi', 'eyJ1c2VyaWQiOjJ9:1oaXJj:WILm4Fm0zrag2zvbtVBNRTueQdxexQ5tuAHNuKwvikY', '2022-10-04 07:05:15.835179'),
...
('mxkgz90vn06ifuxlkpvn5p96tbomiyrq', 'eyJ1c2VyaWQiOjF9:1oaWki:bykLjnWRrO9uAYhLcf6sogPVofZRey0ej_uk_asuZTk', '2022-10-04 06:29:04.609992'),
...
('rux17zx1g1dfp7lvzd4n2hj7f1t9xrye', 'eyJ1c2VyaWQiOjJ9:1qnx3X:nvbauj-0Na0mZ8iDo9-4RcN3VFC000Cv9rHfnhMu5OQ', '2023-10-18 08:16:31.953866'),
...
(1, 'Naveen', 'Naveen123@gmail.com', 'Naveen', '9535866270', 'India', 'Karnataka', 'Bangalore', 'Male', '#8928,4th Cross,Rajajinagar'),
(2, 'Manjunath', 'tmksmanju14@gmail.com', 'Manjunath', '9535866270', 'India', 'karnataka', 'Bangalore', 'Male', '#8928,4th Cross,Rajajinagar');
...
(30, 'Multi-modal neural networks (MMNN)', '60.039761431411534'),
(31, 'SVM', '60.93439363817097'),
(32, 'Logistic Regression', '61.63021868787276'),
(33, 'Decision Tree Classifier', '59.443339960238575'),
(34, 'Gradient Boosting Classifier', '61.92842942345924');
...
(16, 'Low Side Effect Found', '50.0'),
(17, 'High Side Effect Found', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_drug_side_effect_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_drug_side_effect_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` varchar(3000) NOT NULL,
  `Drug_Name` varchar(3000) NOT NULL,
  `Condition1` varchar(3000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=13 ;

--
-- Dumping data for table `remote_user_drug_side_effect_prediction`
--

INSERT INTO `remote_user_drug_side_effect_prediction` (`id`, `uid`, `Drug_Name`, `Condition1`, `Prediction`) VALUES
(7, '8ilzm51q', 'Aripiprazole', 'Bipolar Disorde', 'High Side Effect Found'),
(8, 'wafvnbdu', 'Keppra', 'Epilepsy', 'Low Side Effect Found'),
(9, 'lfm6erzy', 'Pentasa', 'Crohn''s Disease', 'Low Side Effect Found'),
(10, '08mep8hm', 'Trimethoprim', 'Urinary Tract Infection', 'High Side Effect Found'),
(11, 'tiyjmih7', 'Tioconazole', 'Vaginal Yeast Infection', 'Low Side Effect Found'),
(12, 'y9sel25v', 'Rizatriptan', 'Migraine', 'High Side Effect Found');
